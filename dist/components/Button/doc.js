...
var doc = function doc(Button) {
  var DocumentedButton = (0, _reactDesc.describe)(Button)
    .availableAt((0, _utils.getAvailableAtBadge)('Button'))
  ...
  DocumentedButton.propTypes = _extends({}, _utils.genericProps, {
    ...
    color: _utils.colorPropType.description(
    ...
    target: _reactDesc.PropTypes.oneOf([
      '_self',
      '_blank',
      '_parent',
      '_top',
...
var themeDoc = _extends(
  ...
  {},
  _utils.themeDocUtils.disabledStyle,
);
