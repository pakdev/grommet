...
var InfiniteScroll = function InfiniteScroll(_ref) {
  ...
  (0, _react.useEffect)(
    function() {
      if (firstPageItemRef.current && lastPageItemRef.current && !pageHeight) {
        ...
        var beginRect = (0, _reactDom.findDOMNode)(
          firstPageItemRef.current,
        ).getBoundingClientRect();
        var endRect = (0, _reactDom.findDOMNode)(
  ...
  (0, _react.useEffect)(
    ...
    [beginPage, endPage, lastPage, multiColumn, pageArea, pageHeight, replace],
