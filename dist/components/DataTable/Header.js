      ...
      columns.map(function(_ref2) {
        ...
        var content =
          typeof header === 'string'
            ? _react['default'].createElement(_Text.Text, null, header)
            : header;
        ...
        if (search || onResize) {
          ...
          var searcher =
            search && filters
              ? _react['default'].createElement(_Searcher.Searcher, {
                  filtering: filtering,
                  filters: filters,
                  property: property,
                  onFilter: onFilter,
...
var HeaderWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
  Header,
);
