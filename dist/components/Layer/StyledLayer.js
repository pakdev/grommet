...
var POSITIONS = {
  center: {
    ...
    horizontal: function horizontal(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';right:', ';top:50%;transform:translateY(-50%);', ''],
        margin.left,
        margin.right,
        function(props) {
  ...
  top: {
    vertical: function vertical(margin) {
      return (0, _styledComponents.css)(
        ['top:', ';bottom:', ';left:50%;transform:translate(-50%,0%);', ''],
        margin.top,
        margin.bottom,
        function(props) {
    ...
    horizontal: function horizontal(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';right:', ';top:', ';transform:translateY(0);', ''],
        margin.left,
        margin.right,
        margin.top,
        function(props) {
  ...
  bottom: {
    ...
    horizontal: function horizontal(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';right:', ';bottom:', ';transform:translateY(0);', ''],
        margin.left,
        margin.top,
        margin.bottom,
        function(props) {
  ...
  left: {
    vertical: function vertical(margin) {
      return (0, _styledComponents.css)(
        ['top:', ';bottom:', ';left:', ';transform:translateX(0);', ''],
        margin.top,
        margin.bottom,
        margin.left,
        function(props) {
    ...
    horizontal: function horizontal(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';right:', ';top:50%;transform:translate(0,-50%);', ''],
        margin.left,
        margin.right,
        function(props) {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';top:50%;transform:translate(0,-50%);', ''],
        margin.left,
        function(props) {
  ...
  right: {
    vertical: function vertical(margin) {
      return (0, _styledComponents.css)(
        ['top:', ';bottom:', ';right:', ';transform:translateX(0);', ''],
        margin.top,
        margin.bottom,
        margin.right,
        function(props) {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['right:', ';top:50%;transform:translate(0,-50%);', ''],
        margin.right,
        function(props) {
  ...
  start: {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['inset-inline-start:', ';top:50%;transform:translate(0,-50%);', ''],
        margin.start,
        function(props) {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['inset-inline-end:', ';top:50%;transform:translate(0,-50%);', ''],
        margin.end,
        function(props) {
  ...
  'top-right': {
    ...
    horizontal: function horizontal(margin) {
      return (0, _styledComponents.css)(
        ['left:', ';right:', ';top:0;transform:translateX(0);', ';'],
        margin.left,
        margin.right,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['top:', ';right:', ';transform:translateY(0);', ';'],
        margin.top,
        margin.right,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
  ...
  'top-left': {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['top:', ';left:', ';transform:translateY(0);', ''],
        margin.top,
        margin.left,
        function(props) {
          return getAnimationStyle(props, 'top', 'true');
  ...
  'bottom-right': {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['bottom:', ';right:', ';transform:translateY(0);', ''],
        margin.bottom,
        margin.right,
        function(props) {
          return getAnimationStyle(props, 'bottom', 'true');
  ...
  'bottom-left': {
    ...
    false: function _false(margin) {
      return (0, _styledComponents.css)(
        ['bottom:', ';left:', ';transform:translateY(0);', ''],
        margin.bottom,
        margin.left,
        function(props) {
          return getAnimationStyle(props, 'bottom', 'true');
...
var desktopContainerStyle = (0, _styledComponents.css)(
  ['position:', ';max-height:', ';max-width:', ';border-radius:', ';', ';'],
  function(props) {
  ...
  function(props) {
    return (
      'calc(100% - ' +
      MARGINS(props.margin, props.theme, 'top') +
      ' - ' +
      MARGINS(props.margin, props.theme, 'bottom') +
      ')'
    );
  },
  function(props) {
    return (
      'calc(100% - ' +
      MARGINS(props.margin, props.theme, 'left') +
      ' - ' +
      MARGINS(props.margin, props.theme, 'right') +
      ')'
    );
  },
  function(props) {
...
var responsiveContainerStyle = (0, _styledComponents.css)([
  'position:relative;max-height:none;max-width:none;border-radius:0;top:0;bottom:0;left:0;right:0;transform:none;animation:none;height:100vh;width:100vw;',
]);
...
var StyledContainer = _styledComponents['default'].div.withConfig({
  ...
  function(props) {
    return (
      ...
      (0, _utils.backgroundStyle)(props.theme.layer.background, props.theme)
    );
  },
  function(props) {
