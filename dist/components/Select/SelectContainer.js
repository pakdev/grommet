  ...
  (function(_Component) {
    ...
    function SelectContainer(props) {
      ...
      _defineProperty(
        _assertThisInitialized(_this),
        'onSearch',
        (0, _utils.debounce)(function(search) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'selectOption', function(
        ...
        return function() {
          ...
          if (onChange) {
            ...
            var nextSelected = Array.isArray(nextValue)
              ? nextValue.map(function(v) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onNextOption', function(
        event,
      ) {
        ...
        while (
          ...
          _this.isDisabled(nextActiveIndex)
        ) {
          nextActiveIndex += 1;
        }
        ...
        if (nextActiveIndex !== options.length) {
          _this.setState(
            ...
            function() {
              ...
              if (
                buttonNode &&
                (0, _utils.isNodeAfterScroll)(buttonNode, optionsNode) &&
          ...
          if (nextActiveIndex >= 0) {
            _this.setState(
              ...
              function() {
                ...
                if (
                  buttonNode &&
                  (0, _utils.isNodeBeforeScroll)(buttonNode, optionsNode) &&
                  optionsNode.scrollTo
                ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onActiveOption', function(
        index,
      ) {
        return function() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onSelectOption', function(
        event,
      ) {
        var options = _this.props.options;
        var activeIndex = _this.state.activeIndex;
      ...
      _defineProperty(_assertThisInitialized(_this), 'optionLabel', function(
        index,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'optionValue', function(
        index,
      ) {
    ...
    SelectContainer.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
    ...
    _proto.render = function render() {
      ...
      var selectOptionsStyle = _extends(
        {},
            ...
            options.length > 0
              ? _react['default'].createElement(
                  ...
                  function(option, index) {
                    ...
                    return _react['default'].createElement(
                      _SelectOption.SelectOption, // eslint-disable-next-line react/no-array-index-key
                      {
                        key: index,
                        ...
                        onMouseOver: !isDisabled
                          ? _this3.onActiveOption(index)
                          : undefined,
                        onClick: !isDisabled
                          ? _this3.selectOption(option)
                          : undefined,
                      },
                      children
