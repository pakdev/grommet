...
var BORDER_SHAPE = _reactDesc.PropTypes.shape({
  ...
  side: _reactDesc.PropTypes.oneOf([
    'top',
    'left',
    'bottom',
    'right',
  ...
  style: _reactDesc.PropTypes.oneOf([
    'solid',
    'dashed',
    'dotted',
    'double',
...
var doc = function doc(Box) {
  var DocumentedBox = (0, _reactDesc.describe)(Box)
    .availableAt((0, _utils.getAvailableAtBadge)('Box'))
    .description(
  ...
  DocumentedBox.propTypes = _extends({}, _utils.genericProps, {
    ...
    hoverIndicator: _utils.hoverIndicatorPropType
      .description(
...
var themeDoc = _extends(
  ...
  _utils.themeDocUtils.edgeStyle(
    'The possible sizes for any of gap, margin, and pad.',
  ),
  {},
  _utils.themeDocUtils.breakpointStyle(
