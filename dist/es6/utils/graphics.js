...
export var polarToCartesian = function polarToCartesian(
  centerX,
  centerY,
  radius,
  angleInDegrees,
...
export var arcCommands = function arcCommands(
  centerX,
  centerY,
  radius,
  startAngle,
...
export var translateEndAngle = function translateEndAngle(
  startAngle,
  anglePer,
  value,
) {
