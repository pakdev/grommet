...
import {
  ...
  StyledVideoControls,
  StyledVideoScrubber,
} from './StyledVideo'; // Split the volume control into 6 segments. Empirically determined.
    ...
    _proto.renderControls = function renderControls() {
      ...
      var captionControls = captions.map(function(caption) {
        return {
          icon: caption.label
            ? undefined
            : React.createElement(Icons.ClosedCaption, {
                color: iconColor,
              }),
          label: caption.label,
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Button, {
            icon: playing
              ? React.createElement(Icons.Pause, {
                  color: iconColor,
                })
