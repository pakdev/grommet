...
describe('Form', function() {
  ...
  test('empty', function() {
    var component = renderer.create(
      React.createElement(Grommet, null, React.createElement(Form, null)),
    );
              ...
              validate: [
                ...
                function(value) {
                  return value.length === 2
                    ? React.createElement(Text, null, ' ReactNode ')
                    : undefined;
                },
                function(value) {
  ...
  test('lazy value', function() {
    ...
    var _render7 = render(
        React.createElement(Grommet, null, React.createElement(Test, null)),
      ),
