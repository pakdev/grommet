  ...
  if (data.horizontal) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-left:', ';', '-right:', ';', ';'],
        kind,
        theme.global.edgeSize[data.horizontal] || data.horizontal,
        kind,
        theme.global.edgeSize[data.horizontal] || data.horizontal,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              ...
              '\n        ' +
                kind +
                '-left: ' +
                (breakpoint.edgeSize[data.horizontal] || data.horizontal) +
                ';\n        ' +
                kind +
                '-right: ' +
                (breakpoint.edgeSize[data.horizontal] || data.horizontal) +
  ...
  if (data.vertical) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-top:', ';', '-bottom:', ';', ';'],
        kind,
        theme.global.edgeSize[data.vertical] || data.vertical,
        kind,
        theme.global.edgeSize[data.vertical] || data.vertical,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              ...
              '\n        ' +
                kind +
                '-top: ' +
                (breakpoint.edgeSize[data.vertical] || data.vertical) +
                ';\n        ' +
                kind +
                '-bottom: ' +
                (breakpoint.edgeSize[data.vertical] || data.vertical) +
  ...
  if (data.top) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-top:', ';', ';'],
        kind,
        theme.global.edgeSize[data.top] || data.top,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              breakpoint,
              '\n        ' +
                kind +
                '-top: ' +
                (breakpoint.edgeSize[data.top] || data.top) +
                ';\n      ',
            )
          : '',
      ),
  ...
  if (data.bottom) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-bottom:', ';', ';'],
        kind,
        theme.global.edgeSize[data.bottom] || data.bottom,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              breakpoint,
              '\n        ' +
                kind +
                '-bottom: ' +
                (breakpoint.edgeSize[data.bottom] || data.bottom) +
                ';\n      ',
            )
          : '',
      ),
  ...
  if (data.left) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-left:', ';', ';'],
        kind,
        theme.global.edgeSize[data.left] || data.left,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              breakpoint,
              '\n        ' +
                kind +
                '-left: ' +
                (breakpoint.edgeSize[data.left] || data.left) +
                ';\n      ',
            )
          : '',
      ),
  ...
  if (data.right) {
    result.push(
      (0, _styledComponents.css)(
        ['', '-right:', ';', ';'],
        kind,
        theme.global.edgeSize[data.right] || data.right,
        responsive && breakpoint
          ? (0, _mixins.breakpointStyle)(
              breakpoint,
              '\n        ' +
                kind +
                '-right: ' +
                (breakpoint.edgeSize[data.right] || data.right) +
                ';\n      ',
            )
          : '',
      ),
...
var inputStyle = (0, _styledComponents.css)(
  ...
  function(props) {
    return (
      (0, _mixins.parseMetricToNum)(props.theme.global.input.padding) -
      (0, _mixins.parseMetricToNum)(props.theme.global.control.border.width)
    );
  },
  function(props) {
    return (
...
var placeholderColor = (0, _styledComponents.css)(['color:', ';'], function(
  props,
) {
...
var disabledStyle = function disabledStyle(componentStyle) {
  return (0, _styledComponents.css)(['opacity:', ';cursor:default;'], function(
    props,
  ) {
