...
var doc = function doc(Calendar) {
  var DocumentedCalendar = (0, _reactDesc.describe)(Calendar)
    .availableAt((0, _utils.getAvailableAtBadge)('Calendar'))
    .description(
  ...
  DocumentedCalendar.propTypes = _extends({}, _utils.genericProps, {
    ...
    range: _reactDesc.PropTypes.bool
      .description(
    ...
    showAdjacentDays: _reactDesc.PropTypes.bool
      .description(
...
var themeDoc = _extends(
  ...
  _utils.themeDocUtils.iconColor,
  {},
