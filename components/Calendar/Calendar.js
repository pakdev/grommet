...
var Calendar = (0, _react.forwardRef)(function(_ref, ref) {
  var _ref$animate = _ref.animate,
    ...
    showAdjacentDays =
      _ref$showAdjacentDays === void 0 ? true : _ref$showAdjacentDays,
    _ref$size = _ref.size,
      ...
      if (targetDisplayBounds) {
        if (targetDisplayBounds[0].getTime() < displayBounds[0].getTime()) {
          ...
          setSlide({
            direction: 'down',
            weeks:
              (0, _utils.daysApart)(displayBounds[0], targetDisplayBounds[0]) /
              7,
          });
        } else if (
          ...
          setSlide({
            direction: 'up',
            weeks:
              (0, _utils.daysApart)(targetDisplayBounds[1], displayBounds[1]) /
              7,
          });
    ...
    if (!showAdjacentDays && otherMonth) {
      ...
      (function() {
        ...
        var dayDisabled =
          ...
          (validBounds && !(0, _utils.betweenDates)(day, validBounds));
    ...
    _react['default'].createElement(
      ...
      header
        ? header({
            ...
            previousInBound: (0, _utils.betweenDates)(
              previousMonth,
              validBounds,
            ),
