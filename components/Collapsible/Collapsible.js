...
var AnimatedBox = (0, _styledComponents['default'])(_Box.Box).withConfig({
  ...
  return (
    ...
    (props.open
      ? '\n    max-' +
        animatedBoxProperty(props.collapsibleDirection) +
        ': unset;\n    visibility: visible;\n  '
      : '\n    max-' +
        animatedBoxProperty(props.collapsibleDirection) +
        ': 0;\n    visibility: hidden;\n    overflow: hidden;\n  ')
...
var Collapsible =
  ...
  (function(_Component) {
    ...
    Collapsible.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
          ...
          requestAnimationFrame(function() {
            requestAnimationFrame(function() {
              ...
              container.style.transition =
                'max-' + dimension + ' ' + speed + 'ms, visibility 50ms';
...
var CollapsibleWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
