...
var Analog =
  ...
  (function(_Component) {
    ...
    Analog.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
      ...
      if (
        ...
        Object.keys(nextState).some(function(k) {
    ...
    _proto.render = function render() {
      ...
      if (precision === 'seconds') {
        secondHand = _react['default'].createElement(
      ...
      if (precision === 'seconds' || precision === 'minutes') {
        minuteHand = _react['default'].createElement(
      ...
      return _react['default'].createElement(
        ...
        secondHand,
        minuteHand,
        _react['default'].createElement(_StyledClock.StyledHour, {
          x1: halfSize,
          y1: halfSize,
          x2: halfSize,
          y2: hourSize,
...
var AnalogWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
  Analog,
);
