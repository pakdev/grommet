...
var Video =
  ...
  (function(_Component) {
    ...
    Video.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
    ...
    function Video(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'update', function() {
        ...
        if (
          (!_this.hasPlayed && !video.paused && !video.loading) ||
          video.currentTime
        ) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'showCaptions', function(
        index,
      ) {
        var videoRef = _this.state.videoRef;
      ...
      _this.update = (0, _utils.throttle)(
        _this.update,
        100,
        _assertThisInitialized(_this),
      );
    ...
    _proto.renderControls = function renderControls() {
      ...
      var captionControls = captions.map(function(caption) {
        return {
          icon: caption.label
            ? undefined
            : _react['default'].createElement(Icons.ClosedCaption, {
                color: iconColor,
              }),
          label: caption.label,
      ...
      return _react['default'].createElement(
        ...
        _react['default'].createElement(
          ...
          _react['default'].createElement(_Button.Button, {
            icon: playing
              ? _react['default'].createElement(Icons.Pause, {
                  color: iconColor,
                })
          ...
          _react['default'].createElement(
            ...
            _react['default'].createElement(
              ...
              _react['default'].createElement(
                _Stack.Stack,
                null,
                _react['default'].createElement(_Meter.Meter, {
...
var VideoWrapper = (0, _recompose.compose)(
  _styledComponents.withTheme,
  _hocs.withForwardRef,
)(VideoDoc || Video);
