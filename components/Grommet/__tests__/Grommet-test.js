...
var SSRTester = function SSRTester(_ref2) {
  ...
  return _react['default'].createElement(
    ...
    _react['default'].createElement(
      _contexts.ResponsiveContext.Consumer,
      null,
      function(size) {
        return _react['default'].createElement(
          _Heading.Heading,
          null,
          'Received size ' + size + ' for ' + ua,
        );
      },
    ),
  );
...
describe('Grommet', function() {
  ...
  test('basic', function() {
    var component = _reactTestRenderer['default'].create(
      _react['default'].createElement(_.Grommet, null),
    );
  ...
  test('grommet theme', function() {
    var component = _reactTestRenderer['default'].create(
      _react['default'].createElement(_.Grommet, {
  ...
  [
    ...
    test('ssr rendering ' + ua.substring(0, 25), function() {
      var component = _reactTestRenderer['default'].create(
        _react['default'].createElement(SSRTester, {
          ua: ua,
        }),
      );
