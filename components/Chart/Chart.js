...
var Chart = _react['default'].forwardRef(function(_ref, ref) {
  ...
  (0, _react.useEffect)(
    function() {
      ...
      var nextStrokeWidth = (0, _utils.parseMetricToNum)(
      ...
      var gapWidth = gap
        ...
        : nextStrokeWidth; // autoWidth is how wide we'd pefer
    ...
    return (values || []).map(function(valueArg, index) {
      ...
      if (top !== 0) {
        ...
        return _react['default'].createElement(
          ...
          _react['default'].createElement('title', null, label),
  ...
  var renderPoints = function renderPoints() {
    return (values || []).map(function(valueArg, index) {
      ...
      if (round) {
        ...
        shape = _react['default'].createElement(
          'circle',
          _extends(
            {
              cx: cx,
  ...
  var drawing = _react['default'].createElement(
    'g',
    {
      stroke: stroke,
  ...
  if (useGradient && size[1]) {
    ...
    var maskId = id + '-mask';
    defs = _react['default'].createElement(
      'defs',
      null,
      _react['default'].createElement(
        'linearGradient',
