    ...
    if (hasBetweenBorder) {
      ...
      styles.push(
        (0, _styledComponents.css)(
          ...
          (0, _utils.parseMetricToNum)(height) / 2 -
            (0, _utils.parseMetricToNum)(borderHeight) / 2,
    ...
    if (hasBetweenBorder) {
      ...
      styles.push(
        (0, _styledComponents.css)(
          ...
          (0, _utils.parseMetricToNum)(width) / 2 -
            (0, _utils.parseMetricToNum)(borderWidth) / 2,
          (0, _utils.borderStyle)(_adjustedBorder, responsive, theme),
        ),
      );
    }
  }
