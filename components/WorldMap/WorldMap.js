...
var updateState = function updateState(state, _ref2) {
  ...
  if (continents) {
    continents.forEach(function(continent) {
      nextState.continents[continent.name] = _extends(
        {},
...
var WorldMap =
  ...
  (function(_Component) {
    ...
    WorldMap.getDerivedStateFromProps = function getDerivedStateFromProps(
      nextProps,
      prevState,
    ) {
    ...
    _proto.render = function render() {
      ...
      if (activeCoords) {
        var d =
          'M' +
          FACTOR * activeCoords[0] +
          ', ' +
          FACTOR * activeCoords[1] +
          ' h0';
        active = _react['default'].createElement(
          'g',
          {
            stroke: 'none',
            fill: 'none',
...
var WorldMapWrapper = (0, _recompose.compose)(_styledComponents.withTheme)(
  WorldMapDoc || WorldMap,
);
