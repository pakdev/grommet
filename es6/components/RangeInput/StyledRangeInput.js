...
var rangeTrackStyle = css(
  ['box-sizing:border-box;width:100%;height:', ';background:', ';', ''],
  function(props) {
...
var StyledRangeInput = styled.input.withConfig({
  ...
  [
    ...
    ';width:100%;padding:0px;cursor:pointer;background:transparent;&:focus{outline:none;}&::-moz-focus-inner{border:none;}&::-moz-focus-outer{border:none;}&::-webkit-slider-runnable-track{',
    ...
    '}',
    ' &::-ms-track{',
    ' border-color:transparent;color:transparent;}&::-ms-fill-lower{background:',
    ';border-color:transparent;}&::-ms-fill-upper{background:',
