...
var renderPanelHeader = function renderPanelHeader(title, active) {
  return React.createElement(
    ...
    React.createElement('strong', null, React.createElement(Text, null, title)),
    React.createElement(
      Text,
      {
        color: 'brand',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, null, 'Panel 1 contents'),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, null, 'Panel 2 contents'),
        ),
      ),
      React.createElement(
        AccordionPanel,
