...
var gapStyle = function gapStyle(
  ...
  if (directionProp === 'column' || directionProp === 'column-reverse') {
    ...
    if (responsiveSize) {
      styles.push(
        breakpointStyle(breakpoint, 'height: ' + responsiveSize + ';'),
      );
    }
    ...
    if (hasBetweenBorder) {
      ...
      styles.push(
        css(
          ...
          parseMetricToNum(height) / 2 - parseMetricToNum(borderHeight) / 2,
    ...
    if (hasBetweenBorder) {
      ...
      styles.push(
        css(
          ...
          parseMetricToNum(width) / 2 - parseMetricToNum(borderWidth) / 2,
          borderStyle(_adjustedBorder, responsive, theme),
        ),
      );
    }
  }
