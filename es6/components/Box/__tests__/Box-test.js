...
describe('Box', function() {
  ...
  test('default', function() {
    var component = renderer.create(
      React.createElement(Grommet, null, React.createElement(Box, null)),
    );
  ...
  test('wrap', function() {
    var component = renderer.create(
      React.createElement(
        Grommet,
        null,
        [true, false, 'reverse'].map(function(wrap) {
  ...
  test('gap', function() {
    var component = renderer.create(
      React.createElement(
        Grommet,
        null,
        ['xsmall', 'small', 'medium', 'large', '80px'].map(function(gap) {
    ...
    var component = renderer.create(
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Box, null, 'one'),
          React.createElement(Box, null, 'two'),
        ),
      ),
    );
    var tree = component.toJSON();
  ...
  test('tag proxied', function() {
    var tagComponent = renderer.create(
      React.createElement(
        Grommet,
        null,
        React.createElement(Box, {
    ...
    var asComponent = renderer.create(
      React.createElement(
        Grommet,
        null,
        React.createElement(Box, {
