...
test('Table renders', function() {
  var component = renderer.create(
    React.createElement(Grommet, null, React.createElement(Table, null)),
  );
...
test('TableHeader renders', function() {
  var component = renderer.create(
    React.createElement(
      Grommet,
      null,
      React.createElement(Table, null, React.createElement(TableHeader, null)),
    ),
  );
  var tree = component.toJSON();
  expect(tree).toMatchSnapshot();
...
test('TableFooter renders', function() {
  var component = renderer.create(
    React.createElement(
      Grommet,
      null,
      React.createElement(Table, null, React.createElement(TableFooter, null)),
    ),
  );
  var tree = component.toJSON();
  expect(tree).toMatchSnapshot();
...
test('TableBody renders', function() {
  var component = renderer.create(
    React.createElement(
      Grommet,
      null,
      React.createElement(Table, null, React.createElement(TableBody, null)),
    ),
  );
  var tree = component.toJSON();
  expect(tree).toMatchSnapshot();
