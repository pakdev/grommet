...
export var controlBorderStyle = css(
...
export var edgeStyle = function edgeStyle(
  kind,
  data,
  responsive,
...
export var inputStyle = css(
  ...
  function(props) {
    return (
      ...
      css(['font-weight:', ';'], props.theme.global.input.weight)
    );
  },
  function(props) {
...
export var placeholderStyle = css(
  [
