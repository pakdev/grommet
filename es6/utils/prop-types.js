...
export var a11yTitlePropType = PropTypes.string.description(
  'Custom label to be used by screen readers. When provided, an aria-label will\n   be added to the element.',
);
export var backgroundDoc = PropTypes.oneOfType([
  PropTypes.string,
  PropTypes.shape({
...
export var colorPropType = PropTypes.oneOfType([
  PropTypes.string,
  PropTypes.shape({
...
export var marginProp = PropTypes.oneOfType([
  PropTypes.oneOf(['none'].concat(MARGIN_SIZES)),
  PropTypes.shape({
...
export var padPropType = PropTypes.oneOfType([
...
export var hoverIndicatorPropType = PropTypes.oneOfType([
  PropTypes.bool,
  PropTypes.string,
