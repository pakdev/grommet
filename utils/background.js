  ...
  if (background) {
    if (typeof background === 'object') {
      ...
      if (typeof dark === 'boolean') {
        ...
        var backgroundColor = (0, _colors.normalizeColor)(
          background.color,
          theme,
        );
...
var backgroundStyle = function backgroundStyle(
  backgroundArg,
  theme,
  textColorArg,
) {
  ...
  if (typeof background === 'object') {
    ...
    if (background.image) {
      ...
      if (background.dark === false) {
        color = (0, _colors.normalizeColor)(
          ...
          (!background.opacity || background.opacity !== 'weak') &&
            'color: ' +
              (0, _colors.normalizeColor)(
                textColor[
                  background.dark || (0, _colors.colorIsDark)(backgroundColor)
                    ? 'dark'
                    : 'light'
                ] || textColor,
                theme,
...
var selectedStyle = (0, _styledComponents.css)(['', ''], function(props) {
  return backgroundStyle(
    (0, _colors.normalizeColor)(
      props.theme.global.selected.background,
      props.theme,
    ),
    props.theme,
...
var getHoverIndicatorStyle = function getHoverIndicatorStyle(
  hoverIndicator,
  theme,
) {
  var background;
